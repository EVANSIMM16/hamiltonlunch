...
class HamiltonLunchApp:
    ...
    def view_menu(self):
        ...
        menu_text = """
        Entrees[$5.00]: Taco Triangles, Country Baked Steak, Cheese Pizza, Sausage Pizza, Pepperoni Pizza, Chicken Sandwich
        Sides[included with entree, without[$2.50]: Green Beans, Carrots, Baked Potato, Salad, French Fries, Corn
        Fruits[included with entree or side, without[.75]: Green Apple, Red Apple, Orange, Banana, Bundle of Grapes
        Drinks[included with entree or side, without [$1.00]: Chocolate Milk, Strawberry Milk, 2% Milk, Apple Juice, Cranberry Juice, Water
        Extras[$1.50]: Lays Chips (Original), Lays Chips (Sour Cream), Cheetos, Doritos (Nacho Cheese), Rice Krispy Treat, Raisins, Cookie, Coke Zero, Fanta Zero, Mello Yello Zero
        """
